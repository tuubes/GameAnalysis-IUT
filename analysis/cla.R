...
dbPath <- "C:/Users/clari/Documents/IUT/Projet tutoré/database"
# Chemin du SGBD (DBMS en anglais) .jar
dbmsPath <- "C:/Users/clari/Documents/IUT/Conduite de projet/h2.jar"
...
x<-dbGetQuery(conn, "SELECT * FROM CreatedItems")
summary(x)
9# Une fois toutes les requêtes effectuées, il faut se déconnecter de la base de données avec dbDisconnect
print("disconnecting")
dbDisconnect(conn)
